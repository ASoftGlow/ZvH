// The majority of the maze code was written by someone on stack exchange
...
public class Maze
{
    ...
    private void generateMaze(Cell startAt)
    {
        ...
        while (!cells.isEmpty())
        {
            ...
            { getCell(cell.x + 1, cell.y), getCell(cell.x, cell.y + 1), getCell(cell.x - 1, cell.y),
    ...
    public void build(int x, int y, int z, int height)
    {
        ZvH.editSession.setBlocks(
                (Region) new CuboidRegion(BlockVector3.at(x, y, z),
                        BlockVector3.at(x + gridDimensionX + 1, y + height, z + gridDimensionY + 1)),
                BukkitAdapter.asBlockType(Material.AIR));
        for (int iy = 0; iy < gridDimensionY; iy++)
        {
            for (int i = 0; i < gridDimensionX; i++)
            {
                ...
                {
                    ZvH.editSession.setBlocks(
                            (Region) new CuboidRegion(BlockVector3.at(x + i, y, z + iy),
                                    BlockVector3.at(x + i + 1, y + height, z + iy + 1)),
                            BukkitAdapter.asBlockType(Material.LIGHT_GRAY_WOOL));
                }
            }
        }
